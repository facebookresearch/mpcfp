...
def main():
    ...
    for rank in range(0, args.world_size):
        ...
        # spawn the processes
        cmd = ["python"] + [args.training_script] + args.training_script_args
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="The number of parties to launch."
        "Each party acts as its own process",
    )
    ...
    parser.add_argument(
        "training_script",
        type=str,
        help="The full path to the single training "
